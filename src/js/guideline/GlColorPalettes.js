...
const useStyles = makeStyles(theme => ({
	...
	contrast_lower: { backgroundColor: theme.palette.primary.lower },
					...
					<Grid container>
						...
						<Grid item xs={12} sm={6} lg={4}>
							...
							<Box className={classes.space}>
								<Box
									className={classes.color}
									classes={{ root: classes.contrast_lower }}
								/>
								<Box
									className={classes.color}
									classes={{ root: classes.contrast_low }}
								/>
								<Box
									className={classes.color}
									classes={{ root: classes.contrast_medium }}
								/>
								<Box
									className={classes.color}
									classes={{ root: classes.contrast_high }}
								/>
								<Box
									className={classes.color}
									classes={{ root: classes.contrast_higher }}
								/>
							</Box>
						</Grid>
					</Grid>
